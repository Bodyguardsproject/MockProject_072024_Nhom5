        ...
        <div className="inline-flex">
          <div className="w-1/4 min-w-[300px] mx-4 mt-40">
            <div className="inline-flex w-full rounded-lg border-[1px] border-yellow-400">
              <div className="w-1/5 pl-1 text-[40px] text-global-color-primary flex justify-center items-center">
                <MdPhone />{" "}
              </div>
            ...
            <div className="inline-flex mt-5 w-full rounded-lg border-[1px] border-yellow-400">
              ...
              <div className="p-2 text-[17px]">
                ...
                For any question regarding our security services, please email
                us
              </div>
            </div>
            <div className="inline-flex mt-5 w-full rounded-lg border-[1px] border-yellow-400">
            ...
            <form className="gap-4">
              ...
              <div className="mt-5 mx-2 w-full">
                ...
                <div className="mt-2">
                  ...
                  />
                  <label
                    htmlFor="personalSecurity"
                    className="cursor-pointer font-medium mr-8"
                  >
                    Personal Security
                  </label>
                  ...
                  />
                  <label
                    htmlFor="eventSecurity"
                    className="cursor-pointer font-medium mr-[55px]"
                  >
                    Event Security
                  </label>
              ...
              <p className="mt-5 mx-2 text-[16px]">
                ...
                <small className="text-red-500">
                  Due to heightened demand, holiday service prices will be
                  higher!!!
                </small>
              </p>
