...
public class ApplyRecruitmentController {
	...
	public ResponseEntity<ApiResponse<List<ApplyRecruitmentResponse>>> getApplicantsByRecruitment(
	...
	public ResponseEntity<ApiResponse<ApplyRecruitmentDetailResponse>> getApplicantDetails(
	...
	public ResponseEntity<ApiResponse<List<ApplyRecruitmentResponse>>> searchApplicants(
			@PathVariable Long recruitmentId, @RequestParam String name) {
